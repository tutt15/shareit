                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-sm-1">
                                    <!-- <a href="/admin/post/add.php" class="btn btn-success btn-md">Thêm</a> -->
                                </div>
                                <div class="col-sm-5">
                                    <?php
                                ...
                                <div class="col-sm-4" style="text-align: right;">                               
                                    <input type="search" id="search_text" class="form-control input-sm" placeholder="Tên tin, danh mục, tác giả, chức vụ" style="float:right; width: 300px;" />
