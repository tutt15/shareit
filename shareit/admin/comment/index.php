                        ...
                        <div class="table-responsive">
                            <div class="row">
                                ...
                                <div class="col-sm-4" style="text-align: right;">                               
                                    <input type="search" id="search_text" class="form-control input-sm" placeholder="Tên người bình luận, tên tin, nội dung" style="float:right; width: 300px;" />
