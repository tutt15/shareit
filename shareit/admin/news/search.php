...
<form action="/admin/news/delMulti.php" method="POST">
        ...
        <tr class="gradeX">
            ...
            <td class="center">   
                <?php
                    if($_SESSION['userInfo']['role'] == 'admin' || $email == $_SESSION['userInfo']['email'] ){
                ?>
                <a href="/admin/news/edit.php?id=<?php echo $news_id ?>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                <?php
                    }
                ?>
                <?php
                    if($_SESSION['userInfo']['role'] == 'admin' || $email == $_SESSION['userInfo']['email']){
                ?>
                <a href="/admin/news/del.php?id=<?php echo $news_id ?>" title="" onclick="return confirm('Bạn có chắc chắn xóa không? (xóa cả bình luận)')" class="btn btn-danger"><i class="fa fa-times"></i> Xóa</a>                                            
                <?php
                    }
                ?>
            </td>
